-- Players-List
CREATE SEQUENCE IF NOT EXISTS players_id_seq; -- fixes bug if no database exists
...
CREATE SEQUENCE IF NOT EXISTS training_singles_id_seq; -- fixes bug if no database exists
...
CREATE SEQUENCE IF NOT EXISTS training_doubles_id_seq; -- fixes bug if no database exists
